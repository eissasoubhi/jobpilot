...
{
    public function testFreelanceOnlyRejectsCdiAndAcceptsFreelance(): void
    {
        ...
        $freelance = (new JobOffer())->fill(['contractType' => 'Mission freelance', 'workMode' => 'Hybride']);
        $cdi = (new JobOffer())->fill(['contractType' => 'CDI', 'workMode' => 'Hybride']);

        self::assertTrue($service->evaluate($freelance, $profile)['eligible']);
