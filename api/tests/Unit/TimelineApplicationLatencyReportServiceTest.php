...
{
    public function testUsesFirstSubmissionAfterDiscoveryAndReturnsAverageAndMedian(): void
    {
        ...
        $result = TimelineApplicationLatencyReportService::summarize([
            ...
            ['jobOfferId' => 3, 'type' => JobTimelineEventType::OFFER_IMPORTED, 'occurredAt' => $at('2026-09-10 10:00:00')],
            ['jobOfferId' => 3, 'type' => JobTimelineEventType::APPLICATION_SUBMITTED, 'occurredAt' => $at('2026-09-11 10:00:00')],
        ]);
